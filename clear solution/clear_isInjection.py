...
def isInjection(originalPage, truePage, falsePage,  negativeLogic=False):
    """Main function to detect potential text injection by highlighting and analyzing discrepancies.
    Includes setup, normalization, and final injection detection logic."""
